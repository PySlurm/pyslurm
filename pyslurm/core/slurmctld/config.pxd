...
cdef class Config:
    ...
    Attributes:
        ...
        epilog (str):
            Script that is executed as root on every node when a Job completes.
        ...
        epilog_slurmctld (str):
            Epilog script in use that is executed by slurmctld at job
            allocation.
        ...
        prolog (str):
            Pathname of a program for the slurmd to execute whenever it is
        ...
        prolog_slurmctld (str):
            Pathname of a program for the slurmctld daemon to execute before
