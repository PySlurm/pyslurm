...
SBATCH_OPTIONS = [
    ...
    _SbatchOpt(None, "acctg-freq", "accounting_gather_freq"),
    ...
    _SbatchOpt(None, "spread-job", "spread_job", True),
    ...
    _SbatchOpt(None, "tmp", "tmp_disk_per_node"),
    _SbatchOpt(None, "uid", "uid"),
