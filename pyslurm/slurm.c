/* Generated by Cython 0.15 on Sun Sep 11 16:17:05 2011 */
...
#endif
#include <math.h>
#define __PYX_HAVE__pyslurm__slurm
#define __PYX_HAVE_API__pyslurm__slurm
#include "stdlib.h"
#include "stdio.h"
#include "string.h"
#include "time.h"
...
/* Module declarations from 'pyslurm.slurm' */
static CYTHON_INLINE char *__pyx_f_7pyslurm_5slurm_stringOrNone(char *); /*proto*/
static CYTHON_INLINE char *__pyx_f_7pyslurm_5slurm_boolToString(int); /*proto*/
#define __Pyx_MODULE_NAME "pyslurm.slurm"
int __pyx_module_is_main_pyslurm__slurm = 0;

/* Implementation of 'pyslurm.slurm' */
...
/* "pyslurm/slurm.pxd":25
 * 	ctypedef int time_t
 * 
 * cdef inline char* stringOrNone(char* value):             # <<<<<<<<<<<<<<
 * 	if value is not NULL:	return value
 * 	return None
 */

static CYTHON_INLINE char *__pyx_f_7pyslurm_5slurm_stringOrNone(char *__pyx_v_value) {
  char *__pyx_r;
 ...
 */
  ...
  /* "pyslurm/slurm.pxd":27
 * cdef inline char* stringOrNone(char* value):
 * 	if value is not NULL:	return value
 * 	return None             # <<<<<<<<<<<<<<
 * 
 * cdef inline char* boolToString(int value):
 */
  __pyx_t_2 = PyBytes_AsString(Py_None); if (unlikely((!__pyx_t_2) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 27; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_t_2;
  goto __pyx_L0;
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("pyslurm.slurm.stringOrNone", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
static CYTHON_INLINE char *__pyx_f_7pyslurm_5slurm_boolToString(int __pyx_v_value) {
  char *__pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  __Pyx_RefNannySetupContext("boolToString");

  /* "pyslurm/slurm.pxd":30
 * 
 * cdef inline char* boolToString(int value):
 * 	if value == 0:	return 'False'             # <<<<<<<<<<<<<<
 * 	return 'True'
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initslurm(void); /*proto*/
PyMODINIT_FUNC initslurm(void)
#else
PyMODINIT_FUNC PyInit_slurm(void); /*proto*/
PyMODINIT_FUNC PyInit_slurm(void)
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_slurm(void)");
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("slurm"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
  ...
  if (__pyx_module_is_main_pyslurm__slurm) {
 ...
 */
  ...
  if (__pyx_m) {
    __Pyx_AddTraceback("init pyslurm.slurm", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pyslurm.slurm");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
