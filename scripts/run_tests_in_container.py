...
def test_run():
    ...
    print(host.check_output(f"{python_short} setup.py build"))
    print(host.check_output(f"{python_short} setup.py install"))
    print(host.check_output("./scripts/configure.sh"))
    print(host.check_output(f"{python_short} -m pip uninstall --yes pytest"))
    print(host.check_output(f"{python_short} -m pip install pytest"))
